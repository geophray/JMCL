...
namespace JMCL.Dataverse.FieldEncryption
{
    ...
    {
        private const string DECRYPT_FIELDS_VARIABLE_NAME = "JMCL.EncryptedFieldService.DecryptColumns";
        private const string LOG_SEARCH_RESULTS_VARIABLE_NAME = "JMCL.EncryptedFieldService.LogSearchResults";
