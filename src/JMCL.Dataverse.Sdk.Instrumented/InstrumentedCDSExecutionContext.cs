...
namespace JMCL.Dataverse.Sdk
{
    ...
    public abstract class InstrumentedCDSExecutionContext : CDSExecutionContext, IInstrumentedCDSExecutionContext
    {
        ...
        public override void Trace(JMCL.Core.eSeverityLevel severityLevel, string message, params object[] args)
        {
            ...
            if (!string.IsNullOrEmpty(message))
            {
                ...
                {
                    var level = (JMCL.Telemetry.eSeverityLevel)(int)severityLevel;                  
