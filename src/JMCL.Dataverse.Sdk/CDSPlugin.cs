namespace JMCL.Dataverse.Sdk
{
    ...
    using System.Linq;
    using JMCL.Dataverse.Sdk.Registrations;
    using JMCL.Core;
    using JMCL.Core.Net;
    ...
    /// telemetry logging outside of the CDS platform. For external telemetry use the JMCL.Dataverse.Sdk.InstrumentedCDSPlugin
    /// from the JMCL.Dataverse.Sdk.Instrumented package.
    /// </summary>
