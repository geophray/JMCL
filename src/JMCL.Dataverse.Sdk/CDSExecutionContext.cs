...
namespace JMCL.Dataverse.Sdk
{
    ...
    /// <see cref="JMCL.Core.IProcessExecutionContext"/> and adds additional functionality.
    /// </summary>
    public abstract class CDSExecutionContext : ICDSExecutionContext 
    {
        ...
        /// when working with code based on the JMCL.Core.ProcessModel framework.
        /// </summary>
        ...
        public EntityMetadata GetEntityMetadata(string logicalName, EntityFilters entityFilters = EntityFilters.All, TimeSpan? cacheTimeout = null)
        {
            ...
            var cacheKey = $"JMCL.Dataverse.GetEntityMetaData.{logicalName}.{(int)entityFilters}";
        ...
        public T GetRecord<T>(EntityReference recordId, string[] columns = null, TimeSpan? cacheTimeout = null) where T : Entity
        {
            ...
            {
                cacheKey = string.Format("JMCL.Dataverse.GetRecord.{0}{1}", recordId.LogicalName, recordId.Id);
