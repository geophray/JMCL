...
namespace JMCL.Azure.Secrets
{
    ...
    {
        const string CACHE_KEY = "JMCL.Azure.SecretProviderFactory";

        private struct SettingKeys
        {
            public static readonly string TenantId = "JMCL.Azure.Secrets.TenantId";
            public static readonly string ClientId = "JMCL.Azure.Secrets.ClientId";
            public static readonly string ClientSecret = "JMCL.Azure.Secrets.ClientSecret";
            public static readonly string VaultName = "JMCL.Azure.Secrets.VaultName";
            public static readonly string CacheTimeout = "JMCL.Azure.Secrets.CacheTimeout";
        }
